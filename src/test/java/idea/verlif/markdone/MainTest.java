...
public class MainTest {
    ...
    public void test() {
        ...
        markDone.append(new InlineItem().heading(1, "MarkDone"))
                .append(new SimpleLineItem()
                        ...
                        .append("MarkDone是一个Markdown构建器", SimpleStyle.BOLD).append("。").line().build())
                ...
                .append(new TableItem().start()
                        .title("元素", TableItem.FLOW.CENTER)
                        .title("对应组件", TableItem.FLOW.CENTER)
                        ...
                        .values("代码块", new InlineItem().code("CodeItem()"))
                        .values("有序列表", new InlineItem().code("OrderedListItem()"))
                        .values("无序列表", new InlineItem().code("DisorderedListItem()"))
                        .values("分割线", new InlineItem().code("HorizontalRuleItem()"))
                        .values("引用块", new InlineItem().code("QuoteItem()"))
                        .values("表格", new InlineItem().code("TableItem()"))
                        .values("任务列表", new InlineItem().code("TodoItem()"))
    ...
    public void allTest() {
        ...
        markDone.append(new InlineItem().heading(1, "这个是测试"))
                ...
                .append(new OrderedListtem().start()
                        .content("第一行")
                        .content("第二行")
                        .content(new OrderedListtem(2).start()
                                .content("第1行")
                                .content("第2行").build())
                        .content("第三行").build())
